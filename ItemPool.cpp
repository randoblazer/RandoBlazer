...
void ItemPool::populate () {
    ...
    populateNpc(ItemIndex::NPC_DOLPHIN2, &progNpc, NpcId::NPC_DOLPHIN2, "Northeast platform Dolphin");
    ...
    populateNpc(ItemIndex::NPC_GRANDPA5, &reqNpc, NpcId::NPC_GRANDPA5, "Prison guard Grandpa");
    ...
    populateNpc(ItemIndex::NPC_BOY, &reqNpc, NpcId::NPC_BOY, "Boy (eastern tunnel to king)");
    ...
    populateNpc(ItemIndex::NPC_GIRL3, &reqNpc, NpcId::NPC_GIRL3, "Girl (east side tunnel)");
    ...
    populateNpc(ItemIndex::NPC_MUSHROOM2, &reqNpc, NpcId::NPC_MUSHROOM2, "Mushroom (south tunnel to Nome)");
    ...
    populateNpc(ItemIndex::NPC_CAT, &progNpc, NpcId::NPC_CAT, "Cat 1 in main room");
    populateNpc(ItemIndex::NPC_CAT2, &progNpc, NpcId::NPC_CAT2, "Cat 2 in main room");
    ...
    populateNpc(ItemIndex::NPC_MOUSE, &progNpc, NpcId::NPC_MOUSE, "Mouse hole entrance mouse");
    ...
    populateNpc(ItemIndex::NPC_GREAT_DOOR, &progNpc, NpcId::NPC_GREAT_DOOR, "Locked Door to Kitchen");
    ...
    populateNpc(ItemIndex::NPC_CHEST_OF_DRAWERS2, &progNpc, NpcId::NPC_CHEST_OF_DRAWERS2, "Herb storage Drawers in attic");
