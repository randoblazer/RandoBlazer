...
enum class NpcId : unsigned int {
    ...
    NPC_MERMAID_DANCE_LEADER          = 153,
    NPC_DOLPHIN_NORTHEAST             = 155,
    ...
    NPC_MERMAID9                      = 194,
    NPC_GREETER_GRANDPA               = 201,
    NPC_GIRL                          = 202,
    NPC_MUSHROOM                      = 203,
    NPC_PATHFINDER_BOY                = 204,
    NPC_GRANDPA2                      = 211,
    ...
    NPC_GRANDMA                       = 234,
    NPC_GIRL2                         = 235,
    NPC_MUSHROOM_TUNNEL               = 238,
    NPC_SNAIL_RACER                   = 239,
    NPC_SNAIL_RACER2                  = 240,
    NPC_GIRL_TUNNEL                   = 242,
    NPC_MUSHROOM3                     = 246,
    NPC_SNAIL                         = 247,
    NPC_GRANDPA_LOGS                  = 248,
    NPC_SNAIL2                        = 250,
    NPC_GRANDPA_LAKE                  = 252,
    NPC_GRANDPA_LUNE                  = 254,
    NPC_GRANDPA_PRISON                = 255,
    NPC_MOUNTAIN_KING                 = 259,
    NPC_PLANT_HERB                    = 265,
    NPC_PLANT                         = 267,
    NPC_CHEST_OF_DRAWERS_MYSTIC_ARMOR = 268,
    NPC_CAT_MOUSEHOLE1                = 269,
    NPC_GREAT_DOOR_ZANTETSU_SWORD     = 274,
    NPC_CAT_MOUSEHOLE2                = 276,
    NPC_GREAT_DOOR_KITCHEN            = 282,
    NPC_CAT3                          = 283,
    NPC_MODEL_TOWN1                   = 286,
    ...
    NPC_MOUSE4                        = 330,
    NPC_STEPS_MARIE                   = 331,
    NPC_CHEST_OF_DRAWERS_ATTIC        = 332,
...
enum class ItemIndex : unsigned int {
    ...
    NPC_MERMAID3,
    NPC_MERMAID_NANA,
    NPC_MERMAID_DANCE_LEADER, // Opens NW platform, alternative path to left side of St Elles
    NPC_DOLPHIN_NORTHEAST,
